...
<div class="mb-5">
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mb-4">
    <div class="col">
      <div class="card text-bg-primary rounded-0 border-0 h-100">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card text-bg-success rounded-0 border-0 h-100">
        <div class="card-body">
          <h2 class="card-title"><?= $buku; ?></h2>
          <p class="card-text">Buku</p>
        </div>
        <a href="<?= base_url("dashboard/admin/buku"); ?>" class="text-light text-decoration-none">
          <div class="card-footer text-center border-0" style="background-color: rgba(0,0,0,0.2);">
            <small>More info <i class="bi bi-arrow-right-circle-fill"></i>
            </small>
          </div>
    ...
    <div class="col">
      <div class="card text-bg-secondary rounded-0 border-0 h-100">
        <div class="card-body">
          <h2 class="card-title"><?= $pinjaman; ?></h2>
          <p class="card-text">Pinjaman Buku</p>
        </div>
        <a href="<?= base_url("dashboard/admin/laporan/pinjaman"); ?>" class="text-light text-decoration-none">
          <div class="card-footer text-center border-0" style="background-color: rgba(0,0,0,0.2);">
            <small>More info <i class="bi bi-arrow-right-circle-fill"></i>
            </small>
          </div>
    ...
    <div class="col">
      <div class="card text-bg-danger rounded-0 border-0 h-100">
        ...
        <a href="<?= base_url("dashboard/admin/laporan/pengembalian"); ?>" class="text-light text-decoration-none">
          <div class="card-footer text-center border-0" style="background-color: rgba(0,0,0,0.2);">
            <small>More info <i class="bi bi-arrow-right-circle-fill"></i>
            </small>
          </div>
